...
def quadratic(x, a, b, c):
    ...
    "*** YOUR CODE HERE ***"
    extreme_x=-b/(2*a)
    extreme_y_1=f(extreme_x,a,b,c)
    extreme_y_2=f(lower_bound(x),a,b,c)
    extreme_y_3=f(upper_bound(x),a,b,c)
    if extreme_x>=lower_bound(x) and extreme_x<=upper_bound(x):
        return interval(min(extreme_y_1,extreme_y_2,extreme_y_3),max(extreme_y_1,extreme_y_2,extreme_y_3))
    else:
        return interval(min(extreme_y_2,extreme_y_3),max(extreme_y_2,extreme_y_3))
